...
export default function OrderDetailModal() {
  ...
  const printReceipt = usePOSStore((s) => s.printReceipt);
    ...
    <Dialog open={open} onOpenChange={(o) => !o && setViewOrder(null)}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Review order items and totals.</DialogDescription>
        </DialogHeader>
        {!viewOrder ? null : (
          <div className="space-y-2">
            <div className="text-sm">
              ...
              <div>
                <span className="font-medium">Status:</span> {viewOrder.status}
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <Button onClick={() => printReceipt(viewOrder)}>Print</Button>
            </div>
          </div>
        )}
      </DialogContent>
